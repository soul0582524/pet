<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"themes/admin_simpleboot3/admin\classification\detail.html";i:1528297641;s:71:"D:\phpStudy\WWW\pets\public\themes\admin_simpleboot3\public\header.html";i:1525682252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap">
    ...
    <form class="well form-inline margin-top-20" >
        <div>
            分类名称：&nbsp;&nbsp;&nbsp;&nbsp;
            <input class="form-control" type="text" id="name" style="width: 200px;" value="<?php echo $detail['name']; ?>" placeholder="请输入分类名称">
        </div>
        ...
        <div style="margin-top: 10px;">
            ...
            <select id="pid" >
                ...
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): if($detail['pid'] == $vo['id']): ?>
        ...
        <div style="margin-top: 20px; margin-left: 80px;">
            <input type="button" class="btn btn-primary" value="<?php echo lang('CHANGE'); ?>" onclick="changeDetail()" />
    ...
    */
    function changeDetail(){
        ...
        var pid  = $('#pid').val();
         ...
         $.ajax({
             url: "<?php echo url('admin/Classification/changeDetail'); ?>",
             type: 'POST',
             dataType: 'json',
