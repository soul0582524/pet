<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"themes/admin_simpleboot3/admin\article\lists.html";i:1527603892;s:70:"D:\phpStudy\WWW\pet\public\themes\admin_simpleboot3\public\header.html";i:1525682252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap">
    ...
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('Admin/BlackWords/index'); ?>">
        ...
        标题：
        <input class="form-control" type="text" name="title" style="width: 200px;" value="<?php echo input('request.words'); ?>" placeholder="标题">
        &nbsp;
