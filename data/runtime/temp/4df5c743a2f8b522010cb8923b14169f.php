<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"themes/simpleboot3/portal\\index.html";i:1525682252;s:63:"D:\phpStudy\WWW\pets\public\themes\simpleboot3\public\head.html";i:1525682252;s:67:"D:\phpStudy\WWW\pets\public\themes\simpleboot3\public\function.html";i:1525682252;s:62:"D:\phpStudy\WWW\pets\public\themes\simpleboot3\public\nav.html";i:1525682252;s:65:"D:\phpStudy\WWW\pets\public\themes\simpleboot3\public\footer.html";i:1525682252;s:66:"D:\phpStudy\WWW\pets\public\themes\simpleboot3\public\scripts.html";i:1525682252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<![endif]-->
<link rel="icon" href="/pets/public/themes/simpleboot3/public/assets/images/favicon.png" type="image/png">
<link rel="shortcut icon" href="/pets/public/themes/simpleboot3/public/assets/images/favicon.png" type="image/png">
<link href="/pets/public/themes/simpleboot3/public/assets/simpleboot3/themes/simpleboot3/bootstrap.min.css" rel="stylesheet">
<link href="/pets/public/themes/simpleboot3/public/assets/simpleboot3/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet"
      type="text/css">
<!--[if IE 7]>
<link rel="stylesheet" href="/pets/public/themes/simpleboot3/public/assets/simpleboot3/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link href="/pets/public/themes/simpleboot3/public/assets/css/style.css" rel="stylesheet">
<style>
...
<script src="/pets/public/themes/simpleboot3/public/assets/js/jquery-1.10.2.min.js"></script>
<script src="/pets/public/themes/simpleboot3/public/assets/js/jquery-migrate-1.2.1.js"></script>
<script src="/pets/public/static/js/wind.js"></script>
	
    <link href="/pets/public/themes/simpleboot3/public/assets/css/slippry/slippry.css" rel="stylesheet">
    <style>
        .caption-wraper {
            position: absolute;
            left: 50%;
...
<nav class="navbar navbar-default navbar-fixed-top active">
    <div class="container active">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/pets/public/"><?php echo (isset($theme_vars['company_name']) && ($theme_vars['company_name'] !== '')?$theme_vars['company_name']:'ThinkCMF'); ?></a>
        </div>
                ...
                <li class="dropdown user login">
                    <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
                        <?php $user=cmf_get_current_user(); if(empty($user['avatar'])): ?>
                            <img src="/pets/public/themes/simpleboot3/public/assets/images/headicon.png" class="headicon">
                            <?php else: ?>
...
if(count($__SLIDE_ITEMS__) == 0): ?>
        ...
        <li>
            ...
            <a href=""><img src="/pets/public/themes/simpleboot3/public/assets/images/demo/1.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">此幻灯片只是演示,您没有设置任何幻灯片,请到后台模板设置！</div>
            </div>
            <a href=""><img src="/pets/public/themes/simpleboot3/public/assets/images/demo/2.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">此幻灯片只是演示,您没有设置任何幻灯片,请到后台模板设置！</div>
            </div>
            <a href=""><img src="/pets/public/themes/simpleboot3/public/assets/images/demo/3.jpg" alt=""></a>
        </li>
                            ...
                            <div class="item-image">
                                <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$vo['category_id'])); ?>">
                                    <?php if(isset($vo['more']['thumbnail'])): if(empty($vo['more']['thumbnail']) || (($vo['more']['thumbnail'] instanceof \think\Collection || $vo['more']['thumbnail'] instanceof \think\Paginator ) && $vo['more']['thumbnail']->isEmpty())): ?>
                                            <img src="/pets/public/themes/simpleboot3/public/assets/images/default-thumbnail.png"
...
<?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <p>
        ...
        <?php endif; if(!(empty($site_info['site_gwa']) || (($site_info['site_gwa'] instanceof \think\Collection || $site_info['site_gwa'] instanceof \think\Paginator ) && $site_info['site_gwa']->isEmpty()))): ?>
            <img src="/pets/public/themes/simpleboot3/public/assets/images/ghs.png">
...
<!-- Le javascript
    ...
    <script src="/pets/public/themes/simpleboot3/public/assets/simpleboot3/bootstrap/js/bootstrap.min.js"></script>
    <script src="/pets/public/static/js/frontend.js"></script>
	<script>
	$(function(){
...
<script src="/pets/public/themes/simpleboot3/public/assets/js/slippry.min.js"></script>
<script>
    $(function () {
        $("#home-slider").slippry({
            transition: 'fade',
